    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div data-aos="fade-up" className="mb-10">
          <h3 className="text-2xl md:text-3xl font-semibold text-center text-red-500">
            History of the brand
          </h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 lg:gap-16 items-start text-gray-800">
          {/* คอลัมน์ซ้าย */}
          <div
          ...
          >
            ...
            <p>
              ...
              <strong>"กว่างเย้า"</strong> และ{" "}
              <strong>หงเต้า (JDB Group)</strong> เริ่มมีปัญหา เนื่องจาก{" "}
          ...
          >
            ...
            <p>
              ...
              เป็นองค์กรขนาดใหญ่ที่ดำเนินธุรกิจครบวงจรตั้งแต่
              การเพาะปลูกวัตถุดิบ การผลิต ไปจนถึงการจำหน่ายเครื่องดื่ม
        ...
        <div className="flex justify-center" data-aos="fade-up">
          {/* <p>
            <strong className="text-red-600 text-2xl">โปรไฟล์กลุ่ม</strong>{" "}
          </p> */}
        </div>
        <GalleryAbout
