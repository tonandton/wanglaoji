...
const LandingPage = () => (
  <>
    <Helmet>
      ...
      <meta
        name="description"
        content="เครื่องดื่มสมุนไพรแท้จากจีน หวังเหล่าจี๋ ช่วยบำรุงร่างกายและเสริมภูมิคุ้มกัน"
      />
      <meta
        property="og:title"
        content="หวังเหล่าจี๋ - เครื่องดื่มสมุนไพรแท้จากจีน"
      />
      <meta
      ...
      <meta
        property="og:image"
        content="https://chaiyo-trading.com/images/wanglaoji.jpg"
      />
      <meta property="og:url" content="https://chaiyo-trading.com/wanglaoji" />
